...
namespace lve 
{
    ...
    {
        assert(isFrameStarted && "cant call endframe while frame is not in a progress");
        auto commandBuffer = getCurrentCommandBuffer();
    ...
    {
        assert(isFrameStarted && "cant call beginSwapChainRenderPass if frame is not progress");
    ...
    void LveRenderer::enddSwapChainRenderPass(VkCommandBuffer commandBuffer)
    {
        assert(isFrameStarted && "cant call enddSwapChainRenderPass if frame is not progress");
